...
Critical vulnerabilities that might open up for external attacks are best reported via the [private security advisory form](https://github.com/sidneyojr/watchtower/security/advisories/new).
